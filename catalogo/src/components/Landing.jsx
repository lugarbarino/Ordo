    ...
    <div className="min-h-screen bg-[#f8f8f8] text-[#373c42]">
      ...
      <section className="px-12 pb-12 pt-8">
        <div className="relative rounded-xl overflow-hidden max-w-[1035px] mx-auto flex items-end" style={{ height: 416 }}>
          ...
          <div className="relative z-10" style={{ padding: '0 67px 52px' }}>
            <h1 className="text-[43px] font-black leading-[1.14] text-white mb-[18px] capitalize">
              Tu catálogo digital<br />listo en minutos
            </h1>
            <p className="text-xl text-white/90 max-w-[526px] leading-[1.4] mb-7">
            ...
            <button onClick={() => setModal('registro')}
              className="bg-[#295e4f] text-white px-6 py-[22px] rounded-[13px] font-semibold text-[1.05rem] cursor-pointer hover:-translate-y-1 hover:shadow-xl transition-all capitalize border-none">
              Creá tu catálogo
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 max-w-[1160px] mx-auto">
          {FEATURES.map(({ icon: Icon, title, desc }, i) => (
            <FadeIn key={title} delay={i * 80}>
              <div className="bg-white rounded-[20px] px-8 py-10 h-full" style={{ boxShadow: '0 4px 34px rgba(0,0,0,.09)' }}>
      ...
      {/* CTA BANNER */}
      <section className="relative overflow-hidden flex items-center" style={{ height: 480 }}>
        ...
        <FadeIn className="relative z-10" style={{ marginLeft: 'clamp(40px,8vw,200px)' }}>
          <div className="bg-white rounded-[20px] px-12 py-11 max-w-[380px]">
            ...
            <button onClick={() => setModal('registro')}
              className="w-full bg-[#295e4f] text-white py-[22px] rounded-[13px] font-semibold text-[1.05rem] cursor-pointer hover:-translate-y-1 hover:shadow-xl transition-all capitalize border-none">
              Creá tu catálogo
            </button>
          </div>
        </FadeIn>
