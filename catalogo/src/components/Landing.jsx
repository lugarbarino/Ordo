...
import { Sparkles, Link, RefreshCw, Palette, Shield, Smartphone, Eye, EyeOff, Heart } from 'lucide-react'
...
function LoginModal({ open, onClose, onRegister }) {
  ...
  const handleLogin = async () => {
    ...
    if (data?.session) window.location.href = '/catalogo/admin'
    onClose()
  }
    ...
    <div className="min-h-screen bg-[#f8f8f8] text-[#373c42]">
      ...
      <section className="px-4 sm:px-12 pb-8 sm:pb-12 pt-4 sm:pt-8">
        <div className="relative rounded-xl overflow-hidden max-w-[1035px] mx-auto flex items-end"
          ...
          <div className="absolute inset-0 bg-cover" style={{ backgroundImage: "url('/hero.png')", backgroundPosition: '70% center' }} />
